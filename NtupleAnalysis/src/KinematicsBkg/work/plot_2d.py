...
LAST USED:
./plot_2d.py --url --normalizeToOne --gridX --gridY --logZ -s png,pdf,C -m KinematicsBkg_FullStats_v3


AVOID WARNINGS:
sh
strList="TT M1500_mH150 M1500_mh125 M300_mH200 M350_mH150 M350_mh125"
for x in $strList; do ./plot_2d.py --url --normalizeToOne --gridX --gridY --logZ -s png,pdf,C -m KinematicsBkg_FullStats_v3 -i $x
done
exit

sh
strList="TT ST_ WW|WZ|ZZ M1500_mH150 M1500_mh125 M300_mH200 M350_mH150 M350_mh125"
for x in $strList; do ./plot_2d.py --url --normalizeToOne --gridX --gridY --logZ -s png,pdf,C -m KinematicsBkg_FullStats_v3 -i $x
done
exit
'''
...
def GetHistoKwargs(h, opts):
    ...
    if "Pt_Vs_MET" in h:
        _kwargs["rebinX"]  =  1
        _kwargs["rebinY"]  =  1
        _kwargs["opts"]    = {"xmax": 800.0, "ymax": 500.0}
    ...
    if "Eta_Vs_Eta" in h:
        _kwargs["rebinX"]  =  1
        _kwargs["rebinY"]  =  1
        _kwargs["opts"]    = {"xmin": 0.0, "xmax": 2.3, "ymin": 0.0, "ymax": 2.3}
        _kwargs["xlabel"]  = None
        _kwargs["ylabel"]  = None
    ...
    if "S_Vs_Y" in h:
        _kwargs["rebinX"] =    2
        _kwargs["rebinY"] =    2
        _kwargs["opts"]   = {"xmin": 0.0, "xmax": +1.0, "ymin": 0.0, "ymax": 0.5}
