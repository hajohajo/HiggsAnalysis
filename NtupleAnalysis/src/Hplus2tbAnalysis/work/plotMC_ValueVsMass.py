...
EXAMPLES:
./plotMC_ValueVsMass.py --gridX --gridY --logY --yMin 1e-2 --yMax 8.0 --refCounter "passed trigger" -m Hplus2tbAnalysis_TopMassLE400_BDT0p40_Binning4Eta5Pt_Syst_NoTopPtReweightCorrXML_10Jan2019
./plotMC_ValueVsMass.py --gridX --gridY --logY --yMin 0.3e-2 --yMax 1.2 --refCounter "ttree: skimCounterAll" -m Hplus2tbAnalysis_TopMassLE400_BDT0p40_Binning4Eta5Pt_Syst_NoTopPtReweightCorrXML_10Jan2019
./plotMC_ValueVsMass.py --counters "passed trigger,passed e selection (Veto),passed mu selection (Veto),Passed tau selection (Veto),passed jet selection (),passed b-jet selection (),passed top selection ()" --logY --yMin 0.3e-2 --yMax 1.2 --refCounter "ttree: skimCounterAll" -m Hplus2tbAnalysis_TopMassLE400_BDT0p40_Binning4Eta5Pt_Syst_NoTopPtReweightCorrXML_10Jan2019


LAST USED:
./plotMC_ValueVsMass.py --logY --yMin 0.3e-2 --yMax 1.2 --refCounter "ttree: skimCounterAll" -m Hplus2tbAnalysis_TopMassLE400_BDT0p40_Binning4Eta5Pt_Syst_NoTopPtReweightCorrXML_10Jan2019
./plotMC_ValueVsMass.py --logY --yMin 0.3e-2 --yMax 1.2 --refCounter "passed trigger" -m Hplus2tbAnalysis_TopMassLE400_BDT0p40_Binning4Eta5Pt_Syst_NoTopPtReweightCorrXML_10Jan2019
...
def GetHistoKwargs(opts):
    ...
    _kwargs     = {
        ...
        "moveLegend"       : {"dx": -0.0 , "dy": -0.38, "dh": -0.0},
        "cutBox"           : {"cutValue": 800.0, "fillColor": 16, "box": False, "line": True, "greaterThan": True},
...
if __name__ == "__main__":
    ...
    SIGNALMASS   = [200, 220, 250, 300, 350, 400, 500, 650, 800, 1000, 1500, 2000, 2500, 3000]
    REFCOUNTER   = "passed trigger" #ttree: skimCounterAll"
    SKIPLIST     = ["Passed tau selection and genuine (Veto)", "b-tag SF", "top-tag SF", "Selected Events", "top cleaning",  "passed METFilter selection ()"]
    GRIDX        = False
    GRIDY        = False
    LOGX         = False
    LOGY         = False
    ...
    opts.allCounters = ["ttree: skimCounterAll", "ttree: skimCounterPassed", "Base::AllEvents", "Base::PUReweighting", "Base::Prescale", 
                        ...
                        "passed PV", "passed e selection (Veto)", "passed mu selection (Veto)", "Passed tau selection (Veto)",
                        "passed jet selection ()", "passed b-jet selection ()", "b-tag SF", "top cleaning", "top-tag SF", "passed top selection ()"]
