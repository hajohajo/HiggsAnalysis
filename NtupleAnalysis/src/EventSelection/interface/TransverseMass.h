...
public:
  ...
  static double reconstruct(const Tau& tau_1,const Muon& muon_1,const Muon& muon_2, const math::XYVectorD& met);
  ...
  static double reconstruct(const Tau& tau_1,const Electron& electron_1,const Electron& electron_2, const math::XYVectorD& met);
