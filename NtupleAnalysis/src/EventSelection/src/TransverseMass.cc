...
double TransverseMass::reconstruct(const Tau& tau_1,const Muon& muon_1,const Muon& muon_2, const math::XYVectorD& met) {
  math::XYVector tauptvec_1 = tau_1.p2();
  math::XYVector muonptvec_1 = muon_1.p2();
  math::XYVector muonptvec_2 = muon_2.p2();

  return TransverseMass::reconstruct(tauptvec_1,muonptvec_1,muonptvec_2,met);
}

double TransverseMass::reconstruct(const Tau& tau_1,const Electron& electron_1,const Electron& electron_2, const math::XYVectorD& met) {
  math::XYVector tauptvec_1 = tau_1.p2();
  math::XYVector electronptvec_1 = electron_1.p2();
  math::XYVector electronptvec_2 = electron_2.p2();

  return TransverseMass::reconstruct(tauptvec_1,electronptvec_1,electronptvec_2,met);
}
