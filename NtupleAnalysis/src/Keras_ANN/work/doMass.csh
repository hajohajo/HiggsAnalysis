...
foreach WP (0.0 0.2 0.4 0.6 0.8 0.9)
    ...
    echo "=== QCD (WP = ${WP})"
    ./plotMass.py -s ${FORMATS} --entries 600000 --filename /uscms_data/d3/aattikis/workspace/pseudomulticrab/Keras/TopTagger/histograms-QCD_7Jets_3BJets.root --saveDir "${SAVE_DIR}/${DIR}" --dir ${DIR} --wp ${WP} --saveName "TopMass_QCD_${WP}" ${VERBOSE}
end    
